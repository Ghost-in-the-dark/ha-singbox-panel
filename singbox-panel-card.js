...
`;var Ot="0.1.0",Z="_group_",Q="_ping_",vt="_clash_mode",yt="Sing-box",Y=class extends ${static properties={_state:{state:!0},_message:{state:!0},_model:{state:!0},_testing:{state:!0}};static styles=$t;constructor(){super(),this._hass=null,this._config={},this._discovered=!1,this._state="loading",this._message="",this._model=null,this._testing={}}static getStubConfig(){return{title:yt}}setConfig(t){if(!t||typeof t!="object")throw new Error("Invalid configuration");this._config={title:yt,...t}}getCardSize(){return 4}set hass(t){this._hass=t,t&&!this._discovered&&(this._discovered=!0,this._discover())}async _discover(){this._state="loading";try{let e=(await this._hass.callWS({type:"config_entries/get"})).filter(o=>o.domain==="singbox");if(e.length===0){this._state="error",this._message="\u0418\u043D\u0442\u0435\u0433\u0440\u0430\u0446\u0438\u044F sing-box \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u0430. \u0423\u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442\u0435 \u0438 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u0442\u0435 ha-singbox.";return}let s=e[0].entry_id,i=await this._hass.callWS({type:"config/entity_registry/list"});if(this._config.entity){let o=i.find(c=>c.entity_id===this._config.entity);o&&o.config_entry_id&&(s=o.config_entry_id)}let r=i.filter(o=>o.config_entry_id===s);if(this._model=this._buildModel(r),this._model.groups.length===0){this._state="error",this._message="\u0413\u0440\u0443\u043F\u043F\u044B \u043F\u0440\u043E\u043A\u0441\u0438 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u044B. \u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435, \u0447\u0442\u043E \u0432 \u043A\u043E\u043D\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u0438 sing-box \u0435\u0441\u0442\u044C selector-\u0433\u0440\u0443\u043F\u043F\u044B.";return}this._state="ready"}catch(t){this._state="error",this._message=`\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0435: ${t&&t.message?t.message:t}`}}_buildModel(t){let e={};for(let a of t)if(a.domain==="sensor"&&a.unique_id&&a.unique_id.includes(Q)){let d=a.unique_id.slice(a.unique_id.lastIndexOf(Q)+Q.length);e[d]=a.entity_id}let s=[],i=new Set;for(let a of t){if(a.domain!=="select"||!a.unique_id||!a.unique_id.includes(Z)||a.unique_id.endsWith(vt))continue;let d=a.unique_id.slice(a.unique_id.lastIndexOf(Z)+Z.length),h=this._hass.states[a.entity_id],l=h&&h.attributes&&Array.isArray(h.attributes.options)?h.attributes.options:[];l.forEach(_=>i.add(_)),s.push({tag:d,entityId:a.entity_id,options:l.map(_=>({tag:_,pingEntity:e[_]||null}))})}let r=Object.keys(e).filter(a=>!i.has(a)).sort().map(a=>({tag:a,pingEntity:e[a]})),o=a=>{let d=t.find(h=>h.domain==="sensor"&&h.unique_id&&h.unique_id.endsWith(a));return d?d.entity_id:null},c=t.find(a=>a.domain==="select"&&a.unique_id&&a.unique_id.endsWith(vt));return{version:o("_version"),uplink:o("_uplink"),downlink:o("_downlink"),uplinkTotal:o("_uplink_total"),downlinkTotal:o("_downlink_total"),memory:o("_memory"),connectionsIn:o("_connections_in"),clashMode:c?c.entity_id:null,groups:s,standalone:r}}_entity(t){return t?this._hass.states[t]:void 0}_stateValue(t){let e=this._entity(t);return e?e.state==="unavailable"?null:e.state:null}_formatSpeed(t){let e=this._entity(t);if(!e||e.state==="unavailable"||e.state==="unknown")return{value:"\u2014",unit:""};let s=Number(e.state);return Number.isFinite(s)?{value:s.toLocaleString(void 0,{maximumFractionDigits:1}),unit:e.attributes&&e.attributes.unit_of_measurement?e.attributes.unit_of_measurement:""}:{value:"\u2014",unit:""}}_formatBytes(t){let e=this._entity(t);if(!e||e.state==="unavailable"||e.state==="unknown")return"\u2014";let s=Number(e.state);if(!Number.isFinite(s))return"\u2014";let i=["B","KiB","MiB","GiB","TiB"],r=s,o=0;for(;r>=1024&&o<i.length-1;)r/=1024,o+=1;let c=o?1:0;return`${r.toLocaleString(void 0,{maximumFractionDigits:c})} ${i[o]}`}_ping(t){let e=this._entity(t.pingEntity);if(!e||e.state==="unavailable"||e.state==="unknown")return null;let s=Number(e.state);return Number.isFinite(s)?s:null}_pingClass(t){return t===null?"none":t<=100?"good":t<=300?"warn":"bad"}_pingText(t){return t===null?"\u2014":`${t} ms`}async _selectNode(t,e){if(this._hass)try{await this._hass.callService("singbox","select_outbound",{group_tag:t,outbound_tag:e})}catch(s){console.error("singbox-panel: select_outbound failed",s)}}async _testGroup(t){if(!(!this._hass||this._testing[t])){this._testing={...this._testing,[t]:!0};try{await this._hass.callService("singbox","url_test",{outbound_tag:t})}catch(e){console.error("singbox-panel: url_test failed",e)}finally{setTimeout(()=>{this._testing={...this._testing,[t]:!1}},4e3)}}}async _pingNode(t){if(!(!this._hass||this._testing[t])){this._testing={...this._testing,[t]:!0};try{await this._hass.callService("singbox","url_test",{outbound_tag:t})}catch(e){console.error("singbox-panel: url_test failed",e)}finally{setTimeout(()=>{this._testing={...this._testing,[t]:!1}},4e3)}}}render(){if(this._state==="error")return u`
                <div class="card">
        ...
        `}_renderNode(t,e,s){let i=this._ping(e),r=e.tag===s,o=!!this._testing[e.tag];return u`
